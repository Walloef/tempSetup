module.exports = {
  ...
  rules: {
    curly: 'error',
    // Prefering double qoutes because of resemblance to classic HTML
    // further reading if needed https://github.com/airbnb/javascript/issues/269
    // https://eslint.org/docs/rules/jsx-quotes
    'jsx-quotes': ['error', 'prefer-single'],

    // Same as react-app, just removing unsafe, since we dont have much of a codebase to support
    ...
    // Forbid more abstract proptypes
    ...
    // Airbnb has { ignorePureComponents: true }, however removing it, since we might want to move functional components direction
    ...
    // Disallows spaces around the equal sign in jsx
    // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-equals-spacing.md
    'react/jsx-equals-spacing': ['error', 'never'],

    // Requiring rel='noreferrer noopener' for external links, and optionally any dynamically generated links
    ...
    // Requires propTypes to be explicitly imported in order to be used by other components
